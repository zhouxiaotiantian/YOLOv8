...
class YOLO(object):
    ...
    def detect_image(self, image, crop = False):
        ...
        ChineseName = { 'Ciconia nigra' : '黑鹳', 'DFBG' : '东方白鹳', 'DB' : '大鸨'  , 'BL' : '白鹭', 'DS' : '戴胜',
        ...
        Chi_EngName = { 'Ciconia nigra' : '黑鹳(Ciconia nigra)', 'DFBG' : '东方白鹳(Ciconia boyciana)', 'DB' : '大鸨(Otis tarda)'  , 'BL' : '白鹭(Egretta garzetta)', 'DS' : '戴胜(Upupa epops)',
        ...
        Measure = {'Ciconia nigra'   : '防鸟刺，防鸟挡板，防鸟盒，防鸟针板，防鸟罩，防鸟护套，防鸟拉线，人工鸟巢，人工栖鸟平台，旋转式风车、反光镜等惊鸟装置，声、光、电等驱鸟装置', 
                   'DFBG' : '挡鸟类、引鸟类、驱鸟类装置', 
        ...
        HarmRank = { 'Ciconia nigra' : '高危', 'DFBG' : '高危', 'DB' : '高危'  , 'BL' : '高危', 'DS' : '高危',
        ...
        ProblemTpye = { 'Ciconia nigra' : '鸟粪闪络、鸟体短接、鸟巢短路', 'DFBG' : '鸟粪闪络、鸟巢短路、鸟体短接', 'DB' : '鸟体短接'  , 'BL' : '鸟粪闪络、鸟巢短路', 'DS' : '鸟粪闪络',
